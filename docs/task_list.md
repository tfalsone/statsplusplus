...
- [x] **RP WAR calibration review** — ~~investigate whether `ip / 70` scaling is too generous for middle relievers.~~ Fixed: calibration IP threshold lowered to 20 for RPs (was 40), regression shifted to P75 to reflect closer/setup production. RP OVR→WAR increased ~0.3 across the board. **Done Session 36.**
